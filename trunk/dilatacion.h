...
class Dilatacion : public OperadorMorfologico{
...
public:
    ...
    Dilatacion( bool ** v) : OperadorMorfologico(v){};
                       ...
                       for(int k = -1; k<2; k++){
                           for(int w =-1; w<2; w++){
                               ...
                               if (vecinos[k+1][w+1] == true)
                                   //si al menos uno de los vecinos.
                                   val = (vecinos[k+1][w+1] & mat[i+k][j+w]);
                                   //si el valor es true cortamos el for.
                               if (val){
                                   k = 2;w = 2; //si es negro pero es para tener una idea.--------------
                               }
                           }
                       }
                   }
